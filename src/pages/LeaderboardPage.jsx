...
import { Trophy as trophyIcon, Medal as medalIcon, ChartLineUp as chartLineIcon, Lightning as boltIcon, Brain as brainIcon } from '@phosphor-icons/react';
            ...
            <div className="mb-4 flex items-center justify-between">
              <div>
                <h2 className="flex items-center gap-2 text-xl font-bold text-white">
                  <SolidIcon
  icon={trophyIcon}
  className="text-cyan-400 text-yellow-300"
/>
                  Top Competitors
                </h2>
          ...
          <aside className="space-y-6">
            ...
            <div className="rounded-3xl border border-cyan-400/20 bg-slate-900/70 p-5 backdrop-blur-md">
              <h2 className="flex items-center gap-2 text-lg font-bold text-white">
                <SolidIcon
  icon={chartLineIcon}
  className="text-cyan-400 text-emerald-300"
/>
                Future Expansion
              </h2>
